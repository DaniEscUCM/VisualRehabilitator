...
public class GridTestBothExplanationActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        setContentView(R.layout.activity_grid_test_both_explanation);
    ...
    private void play_test(View v) {
        Intent i = new Intent( this, GridTestBothActivity.class );
        startActivity(i);
    }
