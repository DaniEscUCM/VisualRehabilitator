...
public class GridTestRightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grid_test_right); DisplayMetrics display = this.getResources().getDisplayMetrics();
