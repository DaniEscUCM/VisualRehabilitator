...
public class SecondTestBothActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_test_both);
    ...
    private void next_test(View v) {
        ...
        i.putExtra("grid_both",value);
        value= getIntent().getExtras().getString("grid_right");
