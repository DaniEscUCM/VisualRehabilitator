...
public class FirstTestBothExplanationActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        setContentView(R.layout.activity_first_test_both_explanation);
    ...
    private void play_test(View v) {
        Intent i = new Intent( this, FirstTestBothActivity.class );
