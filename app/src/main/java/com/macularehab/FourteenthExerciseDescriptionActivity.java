...
public class FourteenthExerciseDescriptionActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourteenth_exercise_description);
    ...
    private void play_exercise(View v) {
        ...
        finish();
        Intent i = new Intent( this, FourteenthExerciseActivity.class );
        startActivity(i);
    }
