...
public class SeventeenthLettersActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        setContentView(R.layout.activity_seventeenth_letters);
    ...
    public void Close(View view){
        Intent intent = new Intent(this, SeventeenthExerciseDescriptionActivity.class);
